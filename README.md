...
If the pipeline should run without templates, that can be done by setting the `skip_templates` parameter. In tthat case, the template DB paths are not necessary:
